...
![Screenshot of CellMinerCDB Application](Slide1_sclc.jpeg)
...
3.  Selected tissues: by default, all tissues are selected and included in the scatter plot. To include or exclude cell lines from specific tissues, the user should specify:
  ...
  - **Select Tissues of Origin Subset/s** functionality at the bottom of the left-hand panel. On Macs, more than one tissue of origin may be selected using the "command" button. On PC's use the "control" key. All cell lines were mapped to the four-level OncoTree cancer tissue type hierarchy developed at <a href="http://www.cbioportal.org/oncotree/" target="_blank" class="dm">Memorial Sloan-Kettering Cancer Center</a>. In the CellminerCDB application, a tissue value is coded as an OncoTree node that can include elements from level 1 to level 4 separated by “:” character. For instance, the cell line DMS-79 is a “Lung” cell line but also more specifically it is a Small Cell Lung Cancer one. So DMS-79 belong to different cancer tissue types (or hierarchical nodes) “Lung” (level 1) and “Lung: Small Cell Lung Cancer (SCLC) ” (level 2). There is no further sub-categorization for DMS-79.
<br><br>
4. Color selection
...
![Screenshot of CellMinerCDB Application](Slide2_sclc.jpeg)
...
![Screenshot of CellMinerCDB Application](Slide3_sclc.jpeg)
...
![Screenshot of CellMinerCDB Application](Slide4_sclc.jpeg)
...
![Screenshot of CellMinerCDB Application](Slide5_sclc.jpeg)
...
![Screenshot of CellMinerCDB Application](Slide6_sclc.jpeg)
...
![Screenshot of CellMinerCDB Application](Slide7_sclc.jpeg)
...
![Screenshot of CellMinerCDB Application](Slide8_sclc.jpeg)
...
![Screenshot of CellMinerCDB Application](Slide9_sclc.jpeg)
...
![Screenshot of CellMinerCDB Application](Slide10_sclc.jpeg)
...
![Screenshot of CellMinerCDB Application](Slide11_sclc.jpeg)
...
![Screenshot of CellMinerCDB Application](Slide12_sclc.jpeg)
...
![Screenshot of CellMinerCDB Application](Slide13_sclc.jpeg)
...
![Screenshot of CellMinerCDB Application](Slide14_sclc.jpeg)
...
![Screenshot of CellMinerCDB Application](Slide15_sclc.jpeg)
...
* <a href="https://www.utsouthwestern.edu/" target="_blank" class="dm">UT Southwestern Medical Center</a>

![Screenshot of CellMinerCDB Application](Slide16_sclc.jpeg)
**Figure 16**: Summary of Molecular Drug Activity Data for the seven data sources currently included in SCLC CellMinerCDB. For molecular data types, the numbers indicate the number of genes with a particular data type. Gene level mutation and methylation (numbers in red) were computed using specific scripts described in cellminercdb paper (see reference below). A Grey tab indicates that is no data available.

![Screenshot of CellMinerCDB Application](Slide17_sclc.jpeg)
...
* <a href="https://raw.githubusercontent.com/cannin/rcellminer/devel/inst/extdata/Drug_MOA_Key.txt" target="_blank" class="dm">NCI</a>
